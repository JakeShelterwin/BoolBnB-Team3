      ...
      <form class="col-md-12 col-lg-6" action="{{route('updateApartment', $apartment['id'])}}" method="post"  enctype="multipart/form-data">
        ...
        <div class="info">
          <ul>
            ...
            <li><b>Descrizione:</b> <textarea rows="4" cols="35" name="description" value="{{old('description', $apartment['description'])}}" placeholder="Inserisci la tua richiesta" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Inserisci la tua richiesta'">{{old('description', $apartment['description'])}}</textarea></li>
          </ul>
